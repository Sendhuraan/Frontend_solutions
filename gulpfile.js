(function() {
	...
	function runSolution(cb) {
		...
		const devServerOptions = {
			contentBase: path.resolve(serve),
			writeToDisk: true,
			stats: {
				colors: true
			}
	...
	exports.startAndCaptureTestBrowsers = series(
		getConfig,
		startAndCaptureTestBrowsers
	);
	exports.startOrCreateCloudInstances = series(
		getConfig,
		startOrCreateCloudInstances
	);
